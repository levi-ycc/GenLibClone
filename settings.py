DOWNLOAD_PATH = "Wiley Trading" # Where do you want the books to be downloaded. Default is the script directory.
...
SHOW_MIRRORS = False # Set to True or False depending if you want the program to show the download mirrors.
